...
define( 'OWM_LONG', 		'enter the longitude of the city you want to fetch the weather forecast for' );
define( 'OWM_LAT', 		'enter the latitude of the city you want to fetch the weather forecast for' );
define( 'OWM_EXCLUDE' , 	'enter the excludes you want' ); //see https://openweathermap.org/api/one-call-api 
...
define( 'FORECAST_ITEMS',	7); // how many forecast items to show. You might need to change the css if you add too many
